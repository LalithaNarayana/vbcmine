...
// ── Support city list (same updated list) ─────────────────────────────────
const supportCities = [
  "Visakhapatnam",
  "Kakinada",
  "Vijayawada",
...
export default function ContactPage() {
  ...
  // Sales form: city + address (no area dropdown)
  ...
  // Support form: type-driven fields
            ...
            {[
              {
                ...
                title: "Visit Us",
                lines: [
                  "VIZAG BROADCASTING COMPANY PVT. LTD. (VBC on Fiber)",
                  "#47-10-20, 401, 4th Floor, Dwaraka Plaza,",
              ...
              },
              {
                icon: <Phone size={20} />,
                title: "Call Us",
                lines: ["(0891) 6677-123", "(0891) 6677-124"],
              },
              {
                icon: <Mail size={20} />,
                title: "Email Us",
                lines: ["sales@vbctv.in", "support@vbctv.in"],
              },
              {
                icon: <Clock size={20} />,
                title: "Working Hours",
            ...
            <div style={{ padding: "36px 40px" }}>
              ...
              {activeTab === "sales" && !salesSubmitted && (
                <>
                  ...
                  {/* Address with landmark (replaces area dropdown) */}
                  <div style={{ marginBottom: 16 }}>
              ...
              {activeTab === "support" && !supportSubmitted && (
                <>
                  ...
                  {/* ── COMPLAINT: Account ID + Mobile only ── */}
                  ...
                  {/* ── I NEED HELP / FEEDBACK: Address + Mobile + Message ── */}
                  {(supportForm.type === "I need help" || supportForm.type === "feedback") && (
                    <>
                      {/* Address with landmark (no city/area) */}
                      <div style={{ marginBottom: 16 }}>
                        <label style={labelStyle}>Address with Landmark</label>
                        <textarea
                          rows={3}
