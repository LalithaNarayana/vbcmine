    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {title && <h3 style={{ fontFamily: "'Rajdhani', sans-serif", fontWeight: 700, fontSize: "18px", color: "#1A1A1A", letterSpacing: "0.5px" }}>{title}</h3>}
          <button onClick={onClose} style={{ background: "none", border: "none", color: "#999", cursor: "pointer", padding: "4px", marginLeft: "auto" }}>
            <X size={20} />
          </button>
        </div>
